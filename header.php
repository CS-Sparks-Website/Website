  ...
  <body <?php body_class(); ?>>
    ...
    <div class="Center">
      <a href="#" style="text-decoration: none">
        <img src="<?php echo get_template_directory_uri() . '/img/UCDLogo.jpg';?>" alt="yoink"  class="align-items-center" height="100" width="100">

       
        <img src="<?php bloginfo('template_url'); ?>/img/CSSparksLogo.jpg" alt="yoink"  class="align-items-center" height="150" width="150">
      </a>
    </div>
